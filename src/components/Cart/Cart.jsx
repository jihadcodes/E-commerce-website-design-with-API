      ...
      <section className="pt-[181px] pb-20">
        <div className="container">
          ...
          <div className="grid grid-cols-4 px-10 py-6 [&>div>h3]:text-black [&>div>h3]:text-[16px] [&>div>h3]:font-popins [&>div>h3]:font-normal [&>div>h3]:leading-6 shadow-cart rounded-sm mb-10">
            ...
            <div className="flex gap-5 items-center justify-center">
              <div className="grid grid-cols-2 gap-4 w-[72px] h-11 border border-[rgba(0,0,0,0.4)] rounded-sm px-3 py-1.5 items-center">
                ...
                <div>
                  <MdKeyboardArrowUp
                    onClick={() => handleIncrement("button1")}
                    className="text-black text-[16px] cursor-pointer"
                  />
                  <MdKeyboardArrowDown
                    onClick={() => handleDecrement("button1")}
                    className="text-black text-[16px] cursor-pointer"
                  />
                </div>
              </div>
          ...
          <div className="grid grid-cols-4 px-10 py-6 [&>div>h3]:text-black [&>div>h3]:text-[16px] [&>div>h3]:font-popins [&>div>h3]:font-normal [&>div>h3]:leading-6 shadow-cart rounded-sm mb-10">
            ...
            <div className="flex gap-5 items-center justify-center">
              <div className="grid grid-cols-2 gap-4 w-[72px] h-11 border border-[rgba(0,0,0,0.4)] rounded-sm px-3 py-1.5 items-center">
                ...
                <div>
                  <MdKeyboardArrowUp
                    onClick={() => handleIncrement("button2")}
                    className="text-black text-[16px] cursor-pointer"
                  />
                  <MdKeyboardArrowDown
                    onClick={() => handleDecrement("button2")}
                    className="text-black text-[16px] cursor-pointer"
                  />
                </div>
              </div>
          ...
          <div className="flex justify-between">
            <a
              href=""
              className="font-popins text-[16px] text-black leading-6 font-medium border border-[rgba(0,0,0,0.5)] rounded-sm py-4 px-12 hover:bg-[#DB4444] duration-500 hover:text-white hover:border-[#DB4444]"
            >
              Return To Shop
            </a>
            <a
          ...
          <div className="flex justify-end pt-28">
            <div className="w-[470px] border border-[#000000] px-[22px] pt-8 pb-12 rounded-sm">
              ...
              <div className="pt-8 text-center">
                <Link
                  to="/checkout"
                  className="font-popins text-[16px] text-white leading-6 font-medium rounded-sm py-4 px-12 bg-[#DB4444]"
                >
                  Procees to checkout
                </Link>
              </div>
