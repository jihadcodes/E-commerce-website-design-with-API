...
const Profile = () => {
  return (
    <section className='pb-[60px] lg:pb-[140px]'>
        <div className="container">
            <div className='text-end py-10 lg:py-20'>
            ...
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-[85px]">
                ...
                <div className="w-full lg:w-[80%] rounded-sm shadow-cart px-4 lg:px-20 pt-6 lg:pt-10 pb-8 lg:pb-14">
                    ...
                    <form action="">
                        {/* Name Row */}
                        <div className='flex flex-col lg:flex-row gap-4 lg:gap-[50px] pb-6'>
                            <div className='w-full lg:w-1/2 flex flex-col [*&>label]:text-[16px] [*&>label]:font-popins [*&>label]:font-normal [*&>label]:leading-6 [*&>label]:text-black'>
                        ...
                        {/* Password */}
                        <div className='flex flex-col gap-4 lg:gap-[50px] pb-6'>
                            <div className='[*&>label]:text-[16px] [*&>label]:font-popins [*&>label]:font-normal [*&>label]:leading-6 [*&>label]:text-black'>
                                ...
                                <div className='flex pt-2 flex-col gap-4'>
                                    <input className='bg-[#F5F5F5] w-full py-3 px-4 rounded-sm outline-0 font-popins text-[16px] font-normal leading-6 text-[rgba(0,0,0,0.5)]' type="text" placeholder="Current Password" />
                                    <input className='bg-[#F5F5F5] w-full py-3 px-4 rounded-sm outline-0 font-popins text-[16px] font-normal leading-6 text-[rgba(0,0,0,0.5)]' type="text" placeholder="New Password" />
                                    <input className='bg-[#F5F5F5] w-full py-3 px-4 rounded-sm outline-0 font-popins text-[16px] font-normal leading-6 text-[rgba(0,0,0,0.5)]' type="text" placeholder="Confirm New Password" />
                                </div>
                            </div>
                        </div>

                        {/* Actions */}
                        <div className='flex justify-end gap-6 lg:gap-8 items-center'>
                            <a href="" className='font-popins font-medium text-[16px] leading-6 text-black'>Cancel</a>
                            <button type='submit' className='bg-[#DB4444] py-4 px-8 lg:px-12 font-popins font-medium text-[16px] leading-6 text-[#FAFAFA] rounded-sm'>Save Changes</button>
                        </div>
                    </form>
                </div>
