          ...
          <div className="flex gap-[70px]">
            <div className="w-[60%]">
                ...
                <div className="flex w-[30%] flex-col gap-4 items-center">
                  {gallery.map((gal) => (
                    <div
                      ...
                      className="bg-[#F5F5F5] py-3 px-6 rounded-sm"
                    >
              ...
              <div className="pt-[92px]">
                <h3 className="font-popins font-semibold text-[36px] lerading-10 text-[#111827] pb-4">
                ...
                <h4 className="font-popins font-semibold text-[24px] leading-8 text-[#4B5563]  pb-10">
                  Features
                </h4>
                <p className="font-popins font-normal text-[16px] text-[#4B5563] leading-6 pb-10">
                  The St. Louis Meramec Canoe Company was founded by Alfred
                ...
                <h4 className="font-popins font-semibold text-[24px] leading-8 text-[#4B5563]">
                  Keywords
                </h4>
                <div className="pt-4 flex gap-2">
                  <a
                    href=""
                    className="flex gap-1 items-center font-popins text-[12px] text-[#4B5563] font-normal leading-4 border border-[#E5E7EB] rounded-[9999px] py-2 px-3.5"
                  >
                    <svg
                      width="13"
                      height="13"
            ...
            <div className="w-[40%]">
                ...
                <div className="flex gap-1 items-center">
                  {Array.from({ length: 5 }).map((_, i) => (
                    <TiStarFullOutline
                      ...
                      className={
                        i < rating
                          ? "text-[#FFAD33] text-[18px]"
                          : "text-[rgba(0,0,0,0.25)] text-[18px]"
                      }
                    />
                  ))}
                </div>
              ...
              <h4 className="pt-4 pb-6 font-inter font-normal text-[24px] leading-6 text-black">
                $192.00
              </h4>
              ...
              <div className="color pt-6 flex items-center gap-6 pb-6">
                <div>
                  <h3 className="font-inter font-normal text-[20px] leading-5 text-black">
                    Colors:
                  </h3>
                </div>
                    ...
                    <div className="mt-2">
                      ...
                      >
                        <span
                          ...
                          className="w-5 h-5 inline-block bg-[${color.bgcolor}] rounded-full"
                        ></span>
                      </label>
                    </div>
                  ))}
                  ...
                  {sizes.map((size) => (
                    <div className="mt-1">
                      ...
                      <label
                        ...
                        className="cursor-pointer"
                      >
                        <span className="w-8 h-8 inline-block rounded-sm border border-[rgba(0,0,0,0.5)] text-center leading-[30px] font-popins font-medium text-[14px] text-black">
                          {size.name}
                        </span>
                      </label>
                    </div>
              ...
              <div className="flex pt-6 items-center gap-4">
                <div className="w-[32%] h-11 flex">
                  ...
                  <div className="w-20 h-11 border-t border-b border-[rgba(0,0,0,0.5)] text-center">
                    <span className="leading-11 font-popins font-medium text-[20px] text-black">
                      {quantity}
                    </span>
                  </div>
                  <div
                ...
                <div className="w-[45%]">
                  <a
                    href=""
                    className="font-popins text-[#FAFAFA] text-[16px] leading-6 font-medium bg-[#DB4444] text-center py-2.5 w-full inline-block rounded-sm"
                  >
                    Add to cart
                  </a>
                </div>
              ...
              <div className="product_item">
                ...
                <p className="font-popins font-medium text-[16px] leading-6 flex gap-3 pt-2 pb-2">
                  <span className="text-[#DB4444]">
                    ${releted.dprice ? releted.dprice : releted.price}
                  </span>
                  {releted.dprice ? (
